 ...
 *
 *  Description:
 *     Custom picocli renderer that hides the Java variable names
 *     from the rendered help.
 */
package com.remal.gombi.kafka.player.picocli.renderer;
        ...
        return new Help(commandSpec, colorScheme) {
            ...
            public IOptionRenderer createDefaultOptionRenderer() {
                return (option, ignored, scheme) -> {
                    ...
                    if (option.negatable()) {
                        // ok to omit if you don't have negatable options
